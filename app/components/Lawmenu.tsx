    ...
    export const lawItems: LawItem[] = [
      {
        ...
        "items": [
          {
            "subTitle": "行政手続法",
            "law_revision_id": "405AC0000000088_20240926_506AC0000000065",
            "topics": [
              { "title": "総則（目的・定義・適用範囲）", "articles": [{ "start": "1", "end": "4" }] },
              { "title": "申請に対する処分（標準処理期間・理由提示）", "articles": [{ "start": "5", "end": "11" }] },
              { "title": "不利益処分（聴聞・弁明の機会・理由提示）", "articles": [{ "start": "13", "end": "31" }] },
              { "title": "行政指導", "articles": [{ "start": "32", "end": "36" }] },
              { "title": "届出", "articles": [{ "start": "37", "end": "37" }] },
              { "title": "命令等制定手続", "articles": [{ "start": "38", "end": "46" }] }
            ]
          },
          {
            "subTitle": "地方自治法",
            "law_revision_id": "322AC0000000067_20260101_506AC1000000064",
            "topics": [
              { "title": "総則（地方自治の本旨・普通地方公共団体・自治事務・法定受託事務）", "articles": [{ "start": "1", "end": "13" }] },
              { "title": "条例（制定権・罰則・法律との関係）", "articles": [{ "start": "14", "end": "16" }] },
              { "title": "議会・長の権限・直接請求（住民投票・解散請求等）", "articles": [{ "start": "74", "end": "100" }, { "start": "242", "end": "244" }] },
              { "title": "執行機関・財務（予算・決算・監査）", "articles": [{ "start": "203", "end": "241" }] },
              { "title": "国の関与・是正要求", "articles": [{ "start": "245", "end": "263" }] }
            ]
          },
          {
            "subTitle": "行政不服審査法",
            "law_revision_id": "426AC0000000068_20250601_504AC0000000068",
            "topics": [
              { "title": "総則（目的・不服申立ての対象・適用除外）", "articles": [{ "start": "1", "end": "8" }] },
              { "title": "審査請求（請求期間・審査庁・審理手続・執行停止）", "articles": [{ "start": "9", "end": "62" }] },
              { "title": "再調査の請求・再審査請求", "articles": [{ "start": "5", "end": "6" }] },
              { "title": "行政不服審査会等", "articles": [{ "start": "67", "end": "79" }] }
            ]
          },
          {
            "subTitle": "行政事件訴訟法",
            "law_revision_id": "337AC0000000139_20250401_505AC0000000047",
            "topics": [
              { "title": "総則・出訴要件（処分性・原告適格・出訴期間）", "articles": [{ "start": "1", "end": "7" }] },
              { "title": "取消訴訟（取消事由・裁量処分・取消判決の効力）", "articles": [{ "start": "8", "end": "36" }] },
              { "title": "義務付け訴訟・差止訴訟・無効等確認訴訟", "articles": [{ "start": "37", "end": "42" }] }
            ]
          },
          {
            "subTitle": "国家賠償法",
            "law_revision_id": "322AC0000000125_19471027_000000000000000",
            "topics": [
              { "title": "公務員の違法行為による賠償責任（1条）", "articles": [{ "start": "1", "end": "1" }] },
              { "title": "営造物責任（2条）", "articles": [{ "start": "2", "end": "2" }] },
              { "title": "免責・求償・民法の適用", "articles": [{ "start": "3", "end": "6" }] }
            ]
          }
        ]
      },
        ...
        "items": [
          {
            "subTitle": "民法総則",
            "topics": [
              { "title": "権利能力・意思能力・行為能力", "articles": [{ "start": "3", "end": "3" }, { "start": "4", "end": "21" }] },
              { "title": "法人（設立・解散・責任）", "articles": [{ "start": "33", "end": "84" }] },
              { "title": "住所・居所・不在者・失踪宣告", "articles": [{ "start": "22", "end": "22" }, { "start": "25", "end": "32" }] },
              { "title": "意思表示（心裡留保・虚偽表示・錯誤・詐欺・強迫）", "articles": [{ "start": "93", "end": "96" }] },
              { "title": "代理（権限・復代理・無権代理・表見代理）", "articles": [{ "start": "99", "end": "117" }] },
              { "title": "無効・取消し・追認", "articles": [{ "start": "119", "end": "126" }] },
              { "title": "条件・期限", "articles": [{ "start": "127", "end": "137" }] },
              { "title": "時効（取得時効・消滅時効・中断・援用）", "articles": [{ "start": "144", "end": "170" }] }
            ]
          },
          {
            "subTitle": "物権",
            "topics": [
              { "title": "物権的請求権", "articles": [{ "start": "198", "end": "198" }] },
              { "title": "物権変動の対抗要件（177条・178条）", "articles": [{ "start": "177", "end": "178" }] },
              { "title": "占有権", "articles": [{ "start": "180", "end": "205" }] },
              { "title": "所有権（取得・共有・建物所有権）", "articles": [{ "start": "206", "end": "242" }] },
              { "title": "地上権・地役権", "articles": [{ "start": "265", "end": "294" }] },
              { "title": "抵当権（効力・実行）", "articles": [{ "start": "369", "end": "398" }] }
            ]
          },
          {
            "subTitle": "債権総論",
            "topics": [
              { "title": "債務不履行（履行遅滞・履行不能）", "articles": [{ "start": "412", "end": "415" }] },
              { "title": "債務不履行の損害賠償", "articles": [{ "start": "415", "end": "419" }] },
              { "title": "契約の解除", "articles": [{ "start": "540", "end": "545" }] },
              { "title": "債権者代位権・詐害行為取消権", "articles": [{ "start": "423", "end": "424" }] },
              { "title": "弁済・相殺", "articles": [{ "start": "474", "end": "513" }] },
              { "title": "保証", "articles": [{ "start": "446", "end": "465" }] }
            ]
          }
        ]
      },
        ...
        "items": [
          {
            "subTitle": "総則・基本原理",
            "topics": [
              { "title": "国民主権・象徴天皇・平和主義", "articles": [{ "start": "前文", "end": "前文" }, { "start": "1", "end": "1" }, { "start": "9", "end": "9" }] },
              { "title": "基本的人権の尊重・公共の福祉", "articles": [{ "start": "11", "end": "13" }] }
            ]
          },
          {
            "subTitle": "国民の権利及び義務",
            "topics": [
              { "title": "基本的人権（自由権・平等権・社会権）", "articles": [{ "start": "14", "end": "22" }] },
              { "title": "表現の自由・信教の自由", "articles": [{ "start": "19", "end": "21" }] },
              { "title": "財産権・生存権", "articles": [{ "start": "25", "end": "29" }] },
              { "title": "参政権（選挙権・被選挙権）", "articles": [{ "start": "15", "end": "18" }] }
            ]
          },
          {
            "subTitle": "統治機構",
            "topics": [
              { "title": "国会（立法権・国会の組織）", "articles": [{ "start": "41", "end": "64" }] },
              { "title": "内閣（行政権・首相の任命）", "articles": [{ "start": "65", "end": "75" }] },
              { "title": "裁判所（司法権・最高裁判所）", "articles": [{ "start": "76", "end": "82" }] },
              { "title": "財政・地方自治", "articles": [{ "start": "83", "end": "95" }] }
            ]
          }
        ]
      },
        ...
        "items": [
          {
            ...
            "topics": [
              { "title": "商人・商業登記・商号", "articles": [{ "start": "4", "end": "5" }, { "start": "6", "end": "9" }, { "start": "11", "end": "15" }] },
              { "title": "商業使用人・代理商", "articles": [{ "start": "16", "end": "27" }] },
              { "title": "商行為の概念・商行為の種類（絶対的・相対的商行為）", "articles": [{ "start": "501", "end": "504" }, { "start": "506", "end": "506" }] },
              { "title": "商行為の代理・時効（商事消滅時効5年）", "articles": [{ "start": "507", "end": "522" }] }
            ]
          },
          {
            "subTitle": "会社法",
            ...
            "topics": [
              { "title": "会社法総則・会社の種類（株式会社・持分会社）", "articles": [{ "start": "1", "end": "4" }] },
              { "title": "株式会社の設立（発起設立・募集設立・定款）", "articles": [{ "start": "25", "end": "30" }, { "start": "57", "end": "70" }] },
              { "title": "株式（株式の内容・譲渡制限・種類株式）", "articles": [{ "start": "107", "end": "109" }, { "start": "139", "end": "147" }] },
              { "title": "機関（株主総会・取締役・監査役・委員会設置会社）", "articles": [{ "start": "295", "end": "329" }, { "start": "326", "end": "373" }] },
              { "title": "計算（貸借対照表・利益処分）", "articles": [{ "start": "431", "end": "463" }] }
            ]
          }
        ]
      },
        ...
        "items": [
          {
            "subTitle": "個人情報保護法",
            "topics": [
              { "title": "総則・定義・基本理念", "articles": [{ "start": "1", "end": "3" }] },
              { "title": "個人情報取扱事業者の義務（利用目的・安全管理）", "articles": [{ "start": "15", "end": "37" }] },
              { "title": "開示・訂正・利用停止等の請求", "articles": [{ "start": "28", "end": "37" }] },
              { "title": "行政機関等の保有個人情報", "articles": [{ "start": "60", "end": "76" }] }
            ]
          }
        ]
      },
      {
        ...
        "law_revision_id": "411AC0000000042_20220401_503AC0000000037",
        "items": [
          {
            "subTitle": "情報公開法",
            "topics": [
              { "title": "総則・開示請求権・開示の範囲", "articles": [{ "start": "1", "end": "5" }] },
              { "title": "不開示情報・部分開示・手続", "articles": [{ "start": "5", "end": "14" }] },
              { "title": "不服申立て・審査会", "articles": [{ "start": "15", "end": "25" }] }
            ]
          }
        ]
      }
                  ...
                  <AccordionDetails sx={{ pl: 2 }}>
                    <List dense>
                      {item.topics.map((topic) => (
                        ...
                        <ListItemButton
                          onClick={() => {
                            if(!loginUserEmail && law.title!=="行政法"){
                              toast.success("ログインすることで、全法令を閲覧できます")
                              return
                            }
                            const revision = law.law_revision_id ?? 
                              law.items.find(item => 
                                item.topics.some(t => t.title === topic.title)
                              )?.law_revision_id ?? 
                              "unknown";
...
// 行政手続法　405AC0000000088_20240926_506AC0000000065
//322AC0000000067_20260101_506AC1000000064 地方自治法
//323AC0000000043_19621001_337AC0000000161 行政代執行法
//326AC1000000004_20260101_507AC1000000065  行政書士法
//426AC0000000068_20250601_504AC0000000068  行政不服審査法
//337AC0000000139_20250401_505AC0000000047 行政事件訴訟法
//322AC0000000125_19471027_000000000000000 国家賠償法
//415AC0000000057_20250601_504AC0000000068 個人情報の保護に関する法律
//411AC0000000042_20220401_503AC0000000037  行政機関の保有する情報の公開に関する法律
// export const lawItems: any[] = [
//   {
//     title: "民法",
//     law_revision_id: "129AC0000000089_20251001_505AC0000000053",
//     items: [
