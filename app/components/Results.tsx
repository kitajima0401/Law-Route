...
const Results = ({results, keyword}: Props) => {
  ...
  return(
    <>
      <div>
        ...
        <div>
          {results.map(result=>
              <div key={result.law_info_law_id} className="bg-white border border-gray-200 rounded-lg shadow-sm p-8 hover:shadow-md transition-shadow">
